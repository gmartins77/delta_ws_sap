...
type
  ...
  // style     : document
  // use       : literal
  // binding   : z_ws_ac_mat_bind
  // service   : z_ws_ac_mat_serv
  // port      : z_ws_ac_mat_bind
  ...
  z_ws_ac_mat = interface(IInvokable)
    ['{31A271A1-D194-D5F6-E419-53A87CD4053B}']
...
begin
  ...
  try
    ...
    begin
      ...
      RIO.URL := Addr;
    RIO.HTTPWebNode.UserName := 'ACCEPT';
    RIO.HTTPWebNode.Password := 'delacc';
//    RIO.HTTPWebNode.ReceiveTimeout := 300;
  finally
